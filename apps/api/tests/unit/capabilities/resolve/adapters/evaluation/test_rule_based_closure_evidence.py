...
from tropos.capabilities.resolve.adapters.evaluation.rule_based_closure_evidence import (
    ClosureEvidenceRules,
    RuleBasedClosureEvidenceEvaluator,
)
from tropos.capabilities.resolve.domain.knowledge_action import ClosureEvidenceStatus
